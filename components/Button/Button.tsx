...
interface IButtonProps extends Omit<ButtonHTMLAttributes<HTMLButtonElement>, 'disabled'>, VariantProps<typeof button> {
...
export const CVAButtonComp = ({
  ...
  return (
    <button className={button({ variant, modifier, size, fullWidth, disabled })}>
